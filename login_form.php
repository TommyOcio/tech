				...
				$('#signin').tooltip('hide');
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Bienvenido a Sistema de Inventario de Recursos Tecnologicos(S.I.R.T.)", { header: 'Acceso Permitido' });
									var delay = 1000;
									...
									{
									$.jGrowl("Please Check your username and Password", { header: 'Error de inicio de sesion' });
									}
									}
								});
								return false;
