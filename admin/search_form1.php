...
<div class="modal-body">
    <form class="form-horizontal" method="post" action="advance_search1.php">
			  ...
			  <option>&larr; Selccionar Serie de Equipo &rarr;</option>
			  <?php
			  ...
			  <?php } ?>
                ...
                <div class="control-group">
                <div class="controls">
                <button type="submit" id="search1" data-placement="left" title="Click to Search" class="btn btn-primary"><i class="icon-search"></i> Buscar</button>
